...
imagenpantallacreditos= loadImage('assets/pantallafinal.png');
}
function setup() {
...
image(imagennave,this.x, this.y, 120, 120);
...
this.y = random(windowHeight, -1000);
...
text('vidas:' + ship.vidas, this.x, this.y + 20);
}
