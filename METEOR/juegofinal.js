...
image(imagenpantallainicial,0,0,windowWidth, windowHeight);
ship.dibujarse();
fill(255);
...
image(imagenpantallacreditos,0,0,windowWidth, windowHeight);
...
image(comandos,0,0,windowWidth, windowHeight);
...
text('VIDAS: ' + ship.vidas, this.x, this.y + (unidad/3));
...
function mousePressed() {
  ...
  if (pantalla == 0 && mouseX<((unidad*2.4)+(unidad*4.2)) && mouseX>unidad*2.4 && mouseY<((unidad*5.33)+(unidad/1.42)) && mouseY>(unidad*5.33) ) {
 ...
 pantalla = 2;
  ...
  if (pantalla == 0 && mouseX<((unidad*2.4)+(unidad*4.2)) && mouseX>unidad*2.4 && mouseY<((unidad*6.1)+(unidad/1.42)) && mouseY>(unidad*6.1) ) {
 ...
 pantalla =1;
     ...
     if (pantalla == 2 && mouseX<((unidad*5.2)+(unidad*3.7))&& mouseX>unidad*5.2 && mouseY<((unidad*8.3)+(unidad)) && mouseY>(unidad*8.3) ) {

 pantalla =0;

  }

       if (pantalla == 3 && mouseX<((unidad*3)+(unidad*3.2)) && mouseX>unidad*3 && mouseY<((unidad*6.2)+(unidad)) && mouseY>(unidad*6.2) ) {
